...
function Skill(props: any) {
    ...
    return (
        <div className="flex bg-sky-50 dark:bg-cyan-950 dark:text-gray-300 py-2 px-4 rounded-lg drop-shadow-md max-w-xs lg:max-w-sm m-2 space-x-4">
...
export function AllSkills() {
    ...
    return (
        <div className="flex flex-col mx-auto text-center relative mt-16">
            <h1 className="text-3xl text-gray-900 dark:dark:text-gray-200">Skills</h1>
